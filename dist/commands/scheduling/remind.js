    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            if (isRecurring) {
                ...
                await scheduler.createRecurringReminder(interaction.user.id, interaction.channel.id, message, timeString, result.insertedId.toString());
                ...
                const result = await remindersCollection.insertOne(reminderDoc);
                await scheduler.createReminder(interaction.user.id, interaction.channel.id, message, timeString, result.insertedId.toString());
                const embed = new EmbedBuilder()
                    .setColor(0x00BFFF)
