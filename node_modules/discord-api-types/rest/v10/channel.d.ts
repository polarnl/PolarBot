...
import type { APIAllowedMentions, APIChannel, APIEmbed, APIExtendedInvite, APIFollowedChannel, APIMessage, APIMessageReference, APIThreadList, APIThreadMember, APIUser, ChannelType, InviteTargetType, MessageFlags, OverwriteType, ThreadAutoArchiveDuration, ThreadChannelType, VideoQualityMode, APIGuildForumTag, APIGuildForumDefaultReactionEmoji, SortOrderType, ForumLayoutType, ChannelFlags, APIAttachment, APIMessageTopLevelComponent, APIMessagePin } from 'discord-api-types/payloads/v10';
import type { _AddUndefinedToPossiblyUndefinedPropertiesOfInterface, _StrictPartial } from 'discord-api-types/utils/internals';
import type { RESTAPIPoll } from 'discord-api-types/rest/v10/poll';
