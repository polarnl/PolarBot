import type { APIBaseMessageNoChannel, APIInvite, APIMessage, APIMessageMentions, APIPartialChannel, APIPartialGuild, APIUser, APIVoiceState, ChannelType, GatewayActivity, OAuth2Scopes, Snowflake } from 'discord-api-types/v10';
import type { RelationshipType, RPCAPIMessageParsedContentMention, RPCAPIMessageParsedContentText, RPCCertifiedDevice, RPCErrorCodes, RPCOAuth2Application, RPCVoiceConnectionStatusPing, RPCVoiceSettingsInput, RPCVoiceSettingsMode, RPCVoiceSettingsOutput, VoiceConnectionStates } from 'discord-api-types/rpc/common';
export * from 'discord-api-types/rpc/common';
